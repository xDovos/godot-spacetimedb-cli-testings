this is not an official [SpacetimeDB](https://github.com/ClockworkLabs/SpacetimeDB) repo.

to use this. download the repo and open it up with Godot .net 4.4.1 version or higher.
...
it is likely that it never be finished. 
i will probably completely rewrite it once official godot support comes out. (hopefully through a gdextension that doesn't need .net)
