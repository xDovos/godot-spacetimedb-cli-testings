...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(ActiveTasks = new(conn));
            AddTable(BaseExpTable = new(conn));
            AddTable(Character = new(conn));
            AddTable(CharacterInventory = new(conn));
            AddTable(CharacterSkills = new(conn));
            AddTable(CharacterStats = new(conn));
            AddTable(Chat = new(conn));
            AddTable(DisallowedWords = new(conn));
            AddTable(ItemTable = new(conn));
            AddTable(ModCommands = new(conn));
            AddTable(SkillTable = new(conn));
            AddTable(StatTable = new(conn));
            AddTable(TaskRequirementTable = new(conn));
            AddTable(TaskRewardTable = new(conn));
            AddTable(TaskTable = new(conn));
            AddTable(Textures = new(conn));
            AddTable(User = new(conn));
            AddTable(UserBanned = new(conn));
            AddTable(UserDoubleConnected = new(conn));
            AddTable(UserInfo = new(conn));
            AddTable(UserMods = new(conn));
            AddTable(UserSus = new(conn));
        }
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            return update.ReducerCall.ReducerName switch {
                "ActiveTaskHandler" => BSATNHelpers.Decode<Reducer.ActiveTaskHandler>(encodedArgs),
                "AddItemTableItem" => BSATNHelpers.Decode<Reducer.AddItemTableItem>(encodedArgs),
                "AddSkillTableSkill" => BSATNHelpers.Decode<Reducer.AddSkillTableSkill>(encodedArgs),
                "AddStatsTableStat" => BSATNHelpers.Decode<Reducer.AddStatsTableStat>(encodedArgs),
                "AddTaskTableTask" => BSATNHelpers.Decode<Reducer.AddTaskTableTask>(encodedArgs),
                "AddTexturesTexture" => BSATNHelpers.Decode<Reducer.AddTexturesTexture>(encodedArgs),
                ...
                "ModTool" => BSATNHelpers.Decode<Reducer.ModTool>(encodedArgs),
                "SendChatMessage" => BSATNHelpers.Decode<Reducer.SendChatMessage>(encodedArgs),
                "SetUserName" => BSATNHelpers.Decode<Reducer.SetUserName>(encodedArgs),
                "StartActiveTaks" => BSATNHelpers.Decode<Reducer.StartActiveTaks>(encodedArgs),
                "WriteToLogs" => BSATNHelpers.Decode<Reducer.WriteToLogs>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            return reducer switch {
                Reducer.ActiveTaskHandler args => Reducers.InvokeActiveTaskHandler(eventContext, args),
                Reducer.AddItemTableItem args => Reducers.InvokeAddItemTableItem(eventContext, args),
                Reducer.AddSkillTableSkill args => Reducers.InvokeAddSkillTableSkill(eventContext, args),
                Reducer.AddStatsTableStat args => Reducers.InvokeAddStatsTableStat(eventContext, args),
                Reducer.AddTaskTableTask args => Reducers.InvokeAddTaskTableTask(eventContext, args),
                Reducer.AddTexturesTexture args => Reducers.InvokeAddTexturesTexture(eventContext, args),
                ...
                Reducer.ModTool args => Reducers.InvokeModTool(eventContext, args),
                Reducer.SendChatMessage args => Reducers.InvokeSendChatMessage(eventContext, args),
                Reducer.SetUserName args => Reducers.InvokeSetUserName(eventContext, args),
                Reducer.StartActiveTaks args => Reducers.InvokeStartActiveTaks(eventContext, args),
                Reducer.WriteToLogs args => Reducers.InvokeWriteToLogs(eventContext, args),
